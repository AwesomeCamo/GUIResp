...
class ProfilPageBadExample extends StatefulWidget {
  @override
  _ProfilPageBadExampleState createState() => _ProfilPageBadExampleState();
}

class _ProfilPageBadExampleState extends State<ProfilPageBadExample> {
  bool _status = true;
